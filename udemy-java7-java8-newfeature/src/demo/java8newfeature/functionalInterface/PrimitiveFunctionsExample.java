...
public class PrimitiveFunctionsExample {
  ...
  private static void predicatePrimitiveFunctions() {
    ...
    System.out.println("Output from LongPredicate is : " + checkLong.test(10L));
  }
  ...
  private static void functionPrimitiveFunctions() {
    ...
    System.out.println("Output from LongToIntFunction is : " + longToInt.applyAsInt(123456789));

    LongToDoubleFunction longToDouble = a -> (double) a;
    System.out.println("Output from LongToDoubleFunction is : " + longToDouble.applyAsDouble(123456789));
    ...
    System.out.println("Output from DoubleToLongFunction is : " + doubleToLong.applyAsLong(10.0));
  ...
  private static void biFunctionPrimitiveFunctions() {
    ...
    System.out.println("Output from ToLongBiFunction is : " + toLongBiFunc.applyAsLong("10", "20"));

    ToDoubleBiFunction<String, String> toDoubleBiFunc = (input1, input2) -> {
      return (Double.parseDouble(input1) + Double.parseDouble(input2));
    };
    System.out.println("Output from ToDoubleBiFunction is : " + toDoubleBiFunc.applyAsDouble("10", "20"));
  }
  ...
  private static void unaryPrimitiveFunctions() {
    ...
    System.out.println("Output from IntUnaryOperator is : " + intUnary.applyAsInt(10));

    LongUnaryOperator longUnary = a -> a * 2;
    System.out.println("Output from LongUnaryOperator is : " + longUnary.applyAsLong(123456789));

    DoubleUnaryOperator doubleUnary = a -> a * 2;
    System.out.println("Output from DoubleUnaryOperator is : " + doubleUnary.applyAsDouble(12.34));
  }

  private static void binaryPrimitiveFunctions() {
    IntBinaryOperator intBinary = (a, b) -> a + b;
    System.out.println("Output from IntBinaryOperator is : " + intBinary.applyAsInt(10, 20));

    LongBinaryOperator longBinary = (a, b) -> a + b;
    System.out.println("Output from LongBinaryOperator is : " + longBinary.applyAsLong(12345, 6789));

    DoubleBinaryOperator doubleBinary = (a, b) -> a + b;
    System.out.println("Output from DoubleBinaryOperator is : " + doubleBinary.applyAsDouble(10.0, 20.0));
  }
}
